...
<body class="flex min-h-screen justify-center items-center bg-black/50">
    <div class="flex flex-col w-1/3 p-6 h-1/2 rounded-md sm:p-10 dark:bg-gray-900 dark:text-gray-100">
            ...
            <div class="space-y-4">
                ...
                <div>
                    <div class="flex justify-between mb-2">
                        ...
                        <a rel="noopener noreferrer" href="#" class="text-xs hover:underline dark:text-gray-400">Forgot
                            password?</a>
                    </div>
            ...
            <div class="space-y-2">
                <div>
                    <button type="submit"
                        ...
                        fdprocessedid="r78vz9">Sign in</button>
                </div>
